...
def check_all_messages(message):
    ...
    response('I speak Igbo,eng lish with a little bit of french',['what language','language','tongue','speak','native tongue'],single_response=True)
    ...
    response('Jammin music',['wyd','up to'], single_response=True)
    ...
    response('Akward',['uhh','sooo','idk','smh'], single_response=True)
